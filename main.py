...
class GameRunner:
    ...
    def render_board(self):
        ...
        QV = self.font.render('Current state\'s Q values ([Hit, Stand], #samples): ([{},{}], {})'.format(
            str(self.agent.Q_values[self.game.state][0]),
            str(self.agent.Q_values[self.game.state][1]),
